module JsonApi
  class Pager
    ...
    attr_reader :scope, :model_class, :safe_params

    delegate :current_page, :next_page, :total_pages, to: :scope

    def initialize(scope, model_class, safe_params = {})
      @scope = scope
      @model_class = model_class
      @safe_params = safe_params.except(:controller, :action, :format)
    end
    ...
    def path(params = {})
      polymorphic_path(model_class, safe_params.merge(params))
    end
  end
end
